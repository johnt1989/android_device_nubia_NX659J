...
load_module "mpq-adapter"
load_module "mpq-dmx-hw-plugin"
load_module "qca_cld3_qca6390"
load_module "qca_cld3_qca6490"
load_module "rmnet_perf"
load_module "rmnet_shs"
load_module "texfat"
